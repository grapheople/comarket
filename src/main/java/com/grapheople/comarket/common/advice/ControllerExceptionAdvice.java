package com.grapheople.comarket.common.advice;
...
public class ControllerExceptionAdvice {
    ...
    @ExceptionHandler(ComarketException.class)
    public ResponseEntity<ResultResponse> handleException(ComarketException e) {
